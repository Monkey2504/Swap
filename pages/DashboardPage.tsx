...
const DashboardPage: React.FC<DashboardPageProps> = ({ duties }) => {
  const notifications: AppNotification[] = [
    ...
    { id: '2', title: 'RGPS Validé', message: 'Votre planning est conforme aux règles de sécurité.', type: 'success', read: true, createdAt: 'Hier' }
  ];
  ...
  const nextDuty = sortedDuties.find(d => new Date(`${d.date}T${d.start_time}`) >= new Date()) || sortedDuties[0];
    ...
    <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 animate-slide-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        <div className="lg:col-span-2 space-y-6 md:space-y-8">
          <div className="glass-card bg-white overflow-hidden border-l-4 border-l-sncb-blue">
            <div className="p-5 border-b border-gray-100 flex justify-between items-center">
               <h3 className="text-[10px] font-black text-sncb-blue uppercase tracking-widest">Dernières Alertes</h3>
              ...
              {notifications.map(n => (
                <div key={n.id} className={`p-4 flex items-start gap-4 hover:bg-gray-50 transition-colors ${!n.read ? 'bg-blue-50/30' : ''}`}>
                  ...
                  <div className="flex-grow">
                    <p className="text-xs font-black text-gray-800 mb-1 leading-none">{n.title}</p>
          ...
          <div className="glass-card overflow-hidden bg-white shadow-xl">
            <div className="bg-sncb-blue p-2 px-6 flex justify-between items-center">
               <span className="text-[9px] font-black text-white uppercase tracking-widest">Prochaine Prestation</span>
               <div className="flex items-center gap-2">
                 <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                 <span className="text-[9px] font-black text-white/80 uppercase">Confirmé</span>
               </div>
            </div>
            ...
            <div className="p-6 md:p-10">
              {nextDuty ? (
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div className="flex gap-3 w-full md:w-auto">
                      <div className="flex-1 md:w-32 p-4 bg-blue-50/50 rounded-2xl border border-blue-100 text-center">
                        <p className="text-[9px] font-black text-sncb-blue/40 uppercase mb-1">PS</p>
                        <p className="text-2xl font-black text-sncb-blue">{nextDuty.start_time}</p>
                      </div>
                      <div className="flex-1 md:w-32 p-4 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                        <p className="text-[9px] font-black text-gray-400 uppercase mb-1">FS</p>
                        <p className="text-2xl font-black text-gray-800">{nextDuty.end_time}</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="py-20 text-center border-2 border-dashed border-gray-100 rounded-3xl">
                  ...
                  <p className="text-gray-400 font-bold uppercase text-[10px]">Scannez votre roster</p>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="glass-card p-6 bg-sncb-blue text-white shadow-xl">
             ...
             <p className="text-[11px] text-white/70 font-medium leading-relaxed mb-8">
               Vos préférences filtrent les meilleures opportunités parmi 24 offres actives.
             </p>
          ...
          <div className="glass-card p-6 bg-white border border-gray-100">
             ...
             <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                   ...
                   <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-center">
                      <p className="text-[8px] font-black text-gray-400 uppercase mb-1">Repos</p>
